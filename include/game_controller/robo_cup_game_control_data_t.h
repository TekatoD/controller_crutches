...
struct robo_cup_game_control_data_t
{
    ...
    uint8_t game_type;             // type of the game (GAME_ROUNDROBIN, GAME_PLAYOFF, GAME_DROPIN)
    ...
    char secondary_state_info[4];   // Extra info on the secondary state
...
struct robo_cup_game_control_return_data_t
{
    char header[4];
    uint8_t version;
...
#ifdef __cplusplus
    // constructor
    robo_cup_game_control_return_data_t() : version(GAMECONTROLLER_RETURN_STRUCT_VERSION)
    {
