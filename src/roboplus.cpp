...
void roboplus_exec(CM730& cm730, LinuxServer& server, LinuxSocket& new_sock, bool& connected,
            ...
            if (data_in != "") {
                ...
                if (p_str_tok[0] == "v") {
                    ...
                    for (int i = 0; i < 256; i++) {
                        ...
                        data_out << ":" << (int) page.header.next << ":" << (int) page.header.exit << ":"
                                 << (int) page.header.stepnum << "]";
                    }
                    data_out << "}";
                    data_out << "{[ME]}\n";
