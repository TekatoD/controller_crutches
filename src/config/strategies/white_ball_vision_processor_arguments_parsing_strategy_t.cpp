...
void white_ball_vision_processor_arguments_parsing_strategy_t::define_description(
...
bool white_ball_vision_processor_arguments_parsing_strategy_t::is_dump_images_enabled() const {
    return m_dump_images_enabled;
}

void white_ball_vision_processor_arguments_parsing_strategy_t::enable_dump_images(bool dump_images_enabled) {
    m_dump_images_enabled = dump_images_enabled;
}

bool white_ball_vision_processor_arguments_parsing_strategy_t::is_display_images_enabled() const {
    return m_display_images_enabled;
}

void white_ball_vision_processor_arguments_parsing_strategy_t::enable_display_images(bool display_images_enabled) {
    m_display_images_enabled = display_images_enabled;
}

const std::string& white_ball_vision_processor_arguments_parsing_strategy_t::get_dump_images_path() const {
