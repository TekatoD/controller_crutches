...
namespace Robot {
    ...
    private:
        ...
        float m_shifting_body_duration{0.0f};
        float m_kicking_duration{0.0f};
        float m_restoring_duration{0.0f};

        float m_cur_shifting_body_duration{0.0f};
        float m_cur_kicking_duration{0.0f};
        float m_cur_restoring_duration_active{0.0f};

        float m_body_x_offset{0.0f};
        float m_body_y_offset{0.0f};
        float m_body_z_offset{0.0f};
