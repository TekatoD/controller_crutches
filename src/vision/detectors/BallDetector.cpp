...
int BallDetector::SetMedianBlurSize(int median_blur_sie) {
    if (m_debug) {
...
bool BallDetector::IsDebugEnabled() {
    return m_debug;
}

void BallDetector::EnableDebug(bool debug) {
    m_debug = debug;
}

const cv::Scalar& BallDetector::GetMinGaborColor() const {
    return m_min_gabor_color;
}

void BallDetector::SetMinGaborColor(const cv::Scalar& min_gabor_color) {
    BallDetector::m_min_gabor_color = min_gabor_color;
}

const cv::Scalar& BallDetector::GetMaxGaborColor() const {
    return m_max_gabor_color;
}

void BallDetector::SetMaxGaborColor(const cv::Scalar& max_gabor_color) {
    BallDetector::m_max_gabor_color = max_gabor_color;
}

const cv::Scalar& BallDetector::GetM_min_color() const {
    return m_min_color;
}

void BallDetector::SetMinColor(const cv::Scalar& min_color) {
    BallDetector::m_min_color = min_color;
}

const cv::Scalar& BallDetector::GetMaxColor() const {
    return m_max_color;
}

void BallDetector::SetMaxColor(const cv::Scalar& max_color) {
    BallDetector::m_max_color = max_color;
}
